...
from trainer_2vnet import Trainer
...
parser.add_argument('--dataset', type=str, default='/ColonDB_5',
                    help='Name of Experiment')
...
parser.add_argument('-VNet1_lr', type=float, default=0.01, help='initial learning rate')
        ...
        for i_batch, sampled_batch in enumerate(train_loader):
            ...
            if iter_num > 0 and iter_num % 200 == 0:
                ...
                wandb.log({
                    ...
                    "train/VNet1_loss": train_metrics["VNet1_loss"],
                    "train/VNet2_loss": train_metrics["VNet2_loss"],
                    "train/fusion_loss": train_metrics["fusion_loss"],
                    "val/sam_mean_dice": val_metrics["sam_mean_dice"],
                    "val/SGDL_mean_dice": val_metrics["SGDL_mean_dice"],
                    "val/vnet1_mean_dice": val_metrics["vnet1_mean_dice"],
                    "val/vnet2_mean_dice": val_metrics["vnet2_mean_dice"],
                }, step=iter_num)
...
if __name__ == '__main__':
    ...
    for fold in range(args.n_fold):
        ...
        snapshot_path = "./Results/ColonDB_5_SAM2_2Vnet"
        ...
        wandb.init(
            ...
            name=f"KnowSAM_ColonDB5_SAM2_2Vnet",
            config=vars(args)
        )
