...
from trainer_1vnet import Trainer
...
parser.add_argument('--dataset', type=str, default='/ColonDB_30',
                    help='Name of Experiment')
...
if __name__ == '__main__':
    ...
    for fold in range(args.n_fold):
        ...
        snapshot_path = "./Results/ColonDB_30_1VNet"
        ...
        shutil.copyfile("./train_semi_SAM_1vnet.py", snapshot_path + "/code/train_semi_SAM_1vnet.py")
        shutil.copyfile("./trainer_1vnet.py", snapshot_path + "/code/trainer_1vnet.py")
