...
parser.add_argument('--mixed_iterations', type=int, default=1000,
        ...
        for i_batch, sampled_batch in enumerate(train_loader):
            ...
            if iter_num > 0 and iter_num % 200 == 0:
                ...
                wandb.log({
                    ...
                    "train/UNet_loss": train_metrics["UNet_loss"],
                    "train/VNet_loss": train_metrics["VNet_loss"],
                    "val/sam_mean_dice": val_metrics["sam_mean_dice"],
                    "val/SGDL_mean_dice": val_metrics["SGDL_mean_dice"],
                    "val/unet_mean_dice": val_metrics["unet_mean_dice"],
                    "val/vnet_mean_dice": val_metrics["vnet_mean_dice"],
                }, step=iter_num)
