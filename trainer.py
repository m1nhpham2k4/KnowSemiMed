...
class Trainer(nn.Module):
    ...
    def train(self, volume_batch, label_batch, iter_num):
        ...
        return {
            ...
            "UNet_VNet_loss": ((UNet_loss + VNet_loss) / 2).item(),
            "fusion_loss": fusion_loss.item(),
            "UNet_loss": UNet_loss.item(),
            "VNet_loss": VNet_loss.item(),
            "UNet_sup_loss": UNet_sup_loss.item(),
            "VNet_sup_loss": VNet_sup_loss.item(),
            "UNet_cons_loss": UNet_cons_loss.item(),
            "VNet_cons_loss": VNet_cons_loss.item(),
            "UNet_enp_loss": UNet_enp_loss.item(),
            "VNet_enp_loss": VNet_enp_loss.item(),
            "UNet_kd_loss": UNet_kd_loss.item(),
            "VNet_kd_loss": VNet_kd_loss.item(),
